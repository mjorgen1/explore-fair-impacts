...
def analysis(y_test, y_pred, sample_weights):
    ...
    return round(results_dict['accuracy']*100, 2), 0, round(f1_micro * 100, 2), round(f1_weighted * 100, 2), round(f1_binary * 100, 2), round(tnr*100, 2), round(tpr*100, 2), round(fner*100, 2), round(fper*100, 2)
