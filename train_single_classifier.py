...
# python train_single_classifier.py --data_path data/final/simData_oom100.csv --output_path data/results/ --model dt --weight_idx 1 --testset_size 0.3
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str,help='Pick a model: dt, gnb, lgr, gbt', required=True)
    ...
    # evaluate model
    results_overall, results_black, results_white = evaluating_model('Un-',X_test,y_test, y_predict, sample_weight_test,race_test)
